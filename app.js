...
function buildSummary(data) {
  ...
  return [
    ...
    "Servicio documental laboral. Representacion ante el SMAC presencial o por apud acta.",
    "",
    "CLIENTE",
    ...
    "",
    "SERVICIO SOLICITADO",
    "Papeleta de conciliacion, presentacion y representacion ante el SMAC presencial o por apud acta.",
    "",
    "PRECIO",
